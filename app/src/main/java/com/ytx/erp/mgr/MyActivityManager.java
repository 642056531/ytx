...
public class MyActivityManager {
    ...
    public void finishActivityByName(String localClassName) {
        if (mActivityStack != null) {
            for (WeakReference<Activity> activityReference : mActivityStack) {
                Activity activity = activityReference.get();
                String name = activity.getLocalClassName().toString();
                Log.e("contextString","name==="+name);
                if (activity != null && activity.getLocalClassName().contains(localClassName)) {
                    activity.finish();
                }
            }
        }
